...
export interface IObjectManagerUseCase {
    ...
    ExecuteGetPresignedPutUrl(objectType: string, userUuid: string, fileName: string, fileType: string, userName: string, organization?: string, idFactura?: string): Promise<string>;
